...
import merchBack from "@/public/assets/T-ShirtBack.png";
import merchFront from "@/public/assets/T-ShirtFront.png";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 px-4 mx-auto">
          ...
          <div className="text-center">
            <div className="flex justify-center space-x-4">
              ...
              <Image src={merchFront} alt={"merchFront"} className="w-40 h-40" />
            </div>
            <p className="mt-2 text-xl font-semibold">Merchandise</p>
          </div>

          {/* Goodies */}
          <div className="text-center">
            <Image src={goodies} alt={"goodies"} className="w-64 h-40 mx-auto" />
            <p className="mt-2 text-xl font-semibold">Goodies</p>
          </div>
        </div>

        {/* === Row 2: Brex, GoDaddy, Google Cloud === */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 px-4 mx-auto mt-8">
